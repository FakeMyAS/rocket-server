    ...
    {1:[function(_dereq_,module,exports){
        ...
        (function() {
            ...
            module.exports = Itinerary.extend({
                ...
                initialize: function(options) {
                    ...
                    //setInterval(this._getGamepadMove, 100);
        ...
        */
        ...
        (function() {
            ...
            module.exports = L.Class.extend({
                options: {
                    serviceUrl: 'http://192.168.4.1:5000/route/v1',
                    profile: 'driving',
                    timeout: 30 * 1000,
                    routingOptions: {
                        alternatives: true,
        ...
        (function() {
            ...
            module.exports = (L.Layer || L.Class).extend({
                ...
                _roundDecimal: function(nombre, precision){
                    if(precision == null)
                        precision = 2;
                ...
                _getGamepadMove: function() {
                    ...
                    if(gamepad.axes[0] < -0.1 || gamepad.axes[0] > 0.1){
                        ...
                        var newMarkerLongitude = this._waypoints[this._waypoints.length-1].getLatLng().lng + gamepad.axes[0] / Math.pow(speed_tab[speed_indice], macarte.getZoom());
                        newMarkerLongitude = this._roundDecimal(newMarkerLongitude, 15);
                        ...
                        var newMarkerLongitude = this._waypoints[this._waypoints.length-1].getLatLng().lng;
                        lon = newMarkerLongitude;
                    }
                
                    //Axe Y pour la latitude
                    if(gamepad.axes[1] < -0.1 || gamepad.axes[1] > 0.1){
                        var newMarkerLatitude = this._waypoints[this._waypoints.length-1].getLatLng().lat + (gamepad.axes[1]*-1) / Math.pow(speed_tab[speed_indice], macarte.getZoom());
                        newMarkerLatitude = this._roundDecimal(newMarkerLatitude, 15);
                        ...
                        var newMarkerLatitude = this._waypoints[this._waypoints.length-1].getLatLng().lat;
                        lat = newMarkerLatitude;
                    }
